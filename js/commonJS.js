...
window.executeOnEventDone("deferredload", function () {
  var A = function (a) {
    ...
    for (i = 0; i < a.length; i++)
      (char = a.charCodeAt(i)), (m = (m << 5) - m + char), (m &= m);
    return "h" + m;
  };
  (function (a) {
    jQuery.expr[":"].parents = function (b, d, c) {
      return jQuery(b).parents(c[3]).length < 1;
    };
    a.fn.attributes = function () {
      var b = a(this)[0];
      if (b)
        return Array.prototype.slice.call(b.attributes).reduce(function (d, c) {
          d[c.name] = c.value;
          return d;
        }, {});
    };
    ...
    a.parseParams = function (b) {
      for (var d = {}, c; (c = m.exec(b)); ) {
        var f = decodeURIComponent(c[1].replace(u, " "));
        d[f] != void 0
          ? (d[f].constructor != Array && (d[f] = [d[f]]),
            d[f].push(decodeURIComponent(c[2].replace(u, " "))))
          : (d[f] = decodeURIComponent(c[2].replace(u, " ")));
      }
      return d;
    };
    a.fn.htmlView = function (b) {
      var d = {
        init: function (c, f, k) {
          ...
          k = a.extend({ method: "GET", enctype: "" }, t, l, k || {});
          this.data("htmlView", {
            view: c,
            state: a.extend({}, f || {}),
            settings: k,
        ...
        load: function (c, f, k) {
          return this.each(function () {
            ...
            g.data("htmlView").view != null &&
              p != null &&
              g.data("htmlView").view != p &&
              (t = {});
            ...
            var B = function () {
              ...
              var q = {
                ...
                data: t,
                success: function (x) {
                  if (l.responseProcessor)
                    try {
                      x = l.responseProcessor(x);
                    } catch (y) {
                      throw (
                        "$.fn.htmlView - Exception while processing response: " +
                        y
                      );
                    }
                  try {
                    if (l.contentmode == "replace") {
                      var z = a(x);
                    ...
                    throw (
                      "$.fn.htmlView - Exception while appending html data: " +
                      y
                    );
                  }
                ...
                error: function (x, z, y) {
                  z != "abort" &&
                    (console.log(x.status + ": " + z + " " + y),
                    g.trigger("viewChange"));
                  g.data("lastJqXHR", null);
                },
                cache: !1,
              };
              l.enctype == "multipart/form-data" &&
                ((q.data = new FormData(h.$context[0])),
                (q.contentType = !1),
                (q.processData = !1));
              q = jQuery.ajax(p, q);
              g.data("lastJqXHR", q);
            ...
            l.confirmmodal
              ? a(l.confirmmodal)
                  .on("close", function (q) {
                    q.currentTarget.returnValue == "confirm"
                      ? B()
                      : g.htmlView("abort");
                  })[0]
                  .showModal()
    ...
    var e,
      ...
      r = function (b) {
        var d = b.find(".slider-selection"),
          ...
          g = parseInt(b.attr("data-precision")) || 0,
          h = k - f;
        c = c.width();
        return {
          min: f,
    ...
    a.fn.slider = function (b, d, c, f) {
      if (b == "value")
        if (
          ((b = a(this)),
          f || (f = r(b)),
          c && c != "none" && (d = (c.pageX - f.offset) * f.ratio + f.min),
          d != void 0)
        )
          (d = Math.max(f.min, Math.min(f.max, d)).toFixed(f.precision)),
            isNaN(d) && (d = f.min.toFixed(f.precision)),
            f.$selectBar.width((d - f.min) * f.percRatio + "%"),
            f.$input.val() != d &&
              (f.$input.val(d), c != "none" && b.trigger("change", d)),
            c && b.trigger("userchange", d);
        else return f.$input.val();
    };
    a(document).ready(function () {
      a(document)
        .on("mousemove touchmove", function (b, d) {
          b.pageX =
            b.pageX ||
            d ||
            (b.changedTouches ? b.changedTouches[0].pageX : null);
    ...
    a.fn.detectAdblock = function () {
      ...
      a(".adBlock:visible").length == 0 &&
        (a("body").addClass("geofs-adsBlocked"), (window.adsBlocked = !0));
    };
    ...
    a.haring = {
      create: function (b, d, c, f) {
        ...
        if (b.isHaring) {
          ...
          (k = a(
            '<div class="geofs-haring"><div class="geofs-content"><p>' +
              b +
              '</p><div class="geofs-closeHaring"><div class="geofs-closeHaring-button">' +
              d +
              "</div></div></div></div>"
          )),
            a("body").append(k);
        b = A(b.replace(/[^A-z]/g, ""));
        a(".geofs-haring." + b).length > 0 ||
          (k.addClass(b),
          c && k.find(".geofs-closeHaring").click(c),
          k.addClass("geofs-cooked"),
          k.css(f),
          k.prependTo("body"),
          setTimeout(function () {
      ...
      update: function (b) {
        a(b || document)
          .find(".geofs-haring:not(.geofs-cooked)")
          .each(function () {
            this.isHaring = !0;
    ...
    a.loadDeferredImages = function (b) {
      b = b || a(document);
      b.find("[data-deferredsrc]").each(function (d, c) {
        a(c)
          .attr("src", a(c).attr("data-deferredsrc"))
          .removeAttr("data-deferredsrc");
      });
      b.find("[data-deferredbackground]").each(function (d, c) {
        a(c).css(
          "background-image",
          "url(" + a(c).attr("data-deferredbackground") + ")"
        );
      });
    };
    a(document).on("viewChange", ".geofs-htmlView", function () {
    ...
    a(window).scroll(function () {
      a.each(a("[data-inviewsrc]"), function () {
        var b = a(this);
        b.offset().top < a(window).scrollTop() + a(window).height() + 100 &&
          b.attr("src", b.attr("data-inviewsrc")).removeAttr("data-inviewsrc");
      });
    });
    a.carousel = function () {
        ...
        function b() {
          ...
          if (g == void 0) {
            ...
            var h = new Image(),
              l = f.eq(0).attr("src");
            h.onload = function () {
              k[0] = a('<div class="photo-holder"></div>')
          ...
          d.data("current", g);
          k[g] ||
            (k[g] = a('<div class="photo-holder"></div>')
              .css("background-image", "url(" + f.eq(g).attr("src") + ")")
              .prependTo(d));
        }
        var d = a(this);
        d.currentHolder = 0;
  ...
  $(document)
    .on("click", ".geofs-openDialog", function () {
      $($(this).attr("data-dialog")).show();
    })
    .on(
      "click",
      ".mdl-dialog .geofs-cancel, .mdl-dialog .geofs-close",
      function () {
    ...
    .on("loginchange", function () {
      (geofs.userRecord.subscribed || geofs.userRecord.schoolid) &&
        $(".geofs-adsense-container, .geofs-adsBlockedMessage").hide();
    })
    ...
    a.authentication = function (m) {
      var u = {
        init: function () {
          ...
          a(document).on("click", ".geofs-google-cordova-login", function () {
            a.authentication("loginGoogleCordova");
          });
          a(document).on("click", ".geofs-apple-login", function () {
            a.authentication("loginApple");
          });
          a(document).on("click", ".geofs-device-login", function () {
            a.authentication("loginDevice");
          });
        ...
        initGoogleGIS: function () {
          ...
          (!geofs.userRecord ||
            geofs.userRecord.role <= geofs.userRoles.anonymous) &&
        ...
        initGoogle: function () {
          window.gapi &&
            gapi.load("auth2", function () {
              gapi.auth2
                .init({ client_id: geofs.googleAppId })
                .isSignedIn.listen(function (e) {
                  e
                    ? a.authentication("loginGoogle")
        ...
        initGoogleCordova: function () {
          typeof GooglePlus !== "undefined" &&
            GooglePlus.trySilentLogin(
              { webClientId: geofs.googleAppId, offline: !1 },
              function (e) {
        ...
        loginGoogleGIS: function (e) {
          a.authentication.loggedInGoogle || google.accounts.id.prompt();
        },
        ...
        loginFacebook: function () {
          geofs.userRecord.role > geofs.userRoles.anonymous ||
            a.authentication.loggedInFacebook ||
            !window.FB ||
            (FB.login(
              function (e) {
        ...
        loginGeoFS: function (e, n) {
          a.authentication.loggedInGeoFS ||
            (e &&
              n &&
              a.authentication("loginServerSide", "school", "geofs", {
                email: e,
                password: n,
              }));
        },
        loginDevice: function () {
          geofs.deviceUUID &&
            ((a.authentication.loggedInDevice = !0),
            a.authentication("loginServerSide", geofs.deviceUUID, "device"));
        },
        loginGoogleCordova: function () {
          typeof GooglePlus !== "undefined" &&
            GooglePlus.login(
              { webClientId: geofs.googleAppId, offline: !0 },
              function (e) {
                a.authentication("loginServerSide", e.idToken, "google", {
                  sessionId: geofs.userRecord.sessionId,
                  deviceId: geofs.deviceUUID,
        ...
        loginApple: function () {
          window.cordova.plugins.SignInWithApple !== "undefined" &&
            window.cordova.plugins.SignInWithApple.signin(
              { requestedScopes: [0, 1] },
              function (e) {
                a.authentication("loginServerSide", e.user, "apple", {
                  sessionId: geofs.userRecord.sessionId,
                  deviceId: geofs.deviceUUID,
                  nohd: !geofs.preferences.graphics.HD,
                  app: !0,
                  apple_authorizationCode: e.authorizationCode,
                  apple_email: e.email,
                  apple_lastname: e.fullName.familyName,
                  apple_firstname: e.fullName.givenName,
                });
              },
              function (e) {}
            );
        ...
        evaluateGoogleLogin: function (e) {
          e &&
            e.credential &&
            (a.authentication("loginServerSide", e.credential, "google"),
            (a.authentication.loggedInGoogle = !0));
        },
        evaluateGeoFSLogin: function (e, n) {
          e &&
            ...
            (response.status == "connected" && response.authResponse.accessToken
              ...
              : (a.authentication.loggedInGeoFS = !1));
        },
        evaluateFacebookLogin: function (e) {
          var n = function (r) {
            r.status == "connected" && r.authResponse.accessToken
              ? a.authentication(
                  "loginServerSide",
        ...
        disconnect: function () {
          ...
          a.authentication("disconnectGoogleCordova");
          a.authentication("disconnectDevice");
          a(".geofs-auth").htmlView(
            "load",
            "/backend/accounts/auth.php",
            { action: "disconnect" },
            { contentmode: "replace", success: function () {} }
          );
        },
        ...
        disconnectGoogleCordova: function () {
          typeof GooglePlus !== "undefined" && GooglePlus.logout();
        },
        ...
        disconnectDevice: function () {
          a.authentication.loggedInDevice = !1;
        },
        logout: function () {
        ...
        loginServerSide: function (e, n, r) {
          geofs.userRecord.role > geofs.userRoles.anonymous ||
            ((e = { action: "connect", clientToken: e, tokenProvider: n }),
            Object.assign(e, r),
            a(".geofs-auth").htmlView("load", "/backend/accounts/auth.php", e, {
              method: "POST",
              contentmode: "replace",
              success: function () {},
            }));
        ...
        updateUI: function () {
          geofs.userRecord && geofs.userRecord.role > geofs.userRoles.anonymous
            ? (a("body")
                .removeClass("geofs-loggedout")
                .addClass("geofs-authenticated"),
              (geofs.userRecord.role != geofs.userRoles.student &&
                geofs.userRecord.role != geofs.userRoles.instructor) ||
                a("body").addClass("geofs-student-role"),
              geofs.userRecord.role >= geofs.userRoles.editor &&
                a("body").addClass("geofs-editor-role"))
            : a("body")
                .addClass("geofs-loggedout")
                .removeClass("geofs-authenticated");
          a(".geofs-enabledWhenAuthenticated").prop(
            "disabled",
            geofs.userRecord.role == geofs.userRoles.anonymous
          );
        },
      ...
      if (u[m])
        return u[m].apply(this, Array.prototype.slice.call(arguments, 1));
      if (typeof m !== "object" && m)
        a.error("Method " + m + " does not exist on authentication plugin");
      else return u.init.apply(this, arguments);
    };
  })(jQuery);
  $.loadAsyncScript("https://connect.facebook.net/en_US/sdk.js");
  $.loadAsyncScript(
    "https://apis.google.com/js/platform.js?onload=googlePlatformLoadCallback"
  );
  $.authentication("init");
});
