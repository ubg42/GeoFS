...
$jscomp.polyfill = function (m, n, h, q) {
  n &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(m, n, h, q)
      : $jscomp.polyfillUnisolated(m, n, h, q));
};
$jscomp.polyfillUnisolated = function (m, n, h, q) {
  ...
  n != q &&
    null != n &&
    $jscomp.defineProperty(h, m, { configurable: !0, writable: !0, value: n });
};
...
$jscomp.polyfill(
  ...
  function (m) {
    ...
    k.prototype.executeOnSettledCallbacks_ = function () {
      if (null != this.onSettledCallbacks_) {
        for (var g = 0; g < this.onSettledCallbacks_.length; ++g)
          z.asyncExecute(this.onSettledCallbacks_[g]);
    ...
    k.race = function (g) {
      return new k(function (p, u) {
        for (
          var A = $jscomp.makeIterator(g), E = A.next();
          !E.done;
          E = A.next()
        )
          h(E.value).callWhenSettled_(p, u);
      });
    };
    k.all = function (g) {
      ...
      return u.done
        ...
        : new k(function (A, E) {
            ...
            do
              U.push(void 0),
                V++,
                h(u.value).callWhenSettled_(ea(U.length - 1), E),
                (u = p.next());
            while (!u.done);
          });
    };
  ...
  function (m) {
    ...
    return m
      ...
      : function (h, q, k) {
          ...
          if (h < q)
            for (; q < k; )
              q in this ? (this[h++] = this[q++]) : (delete this[h++], q++);
          else
            for (k = Math.min(k, z + q - h), h += k - q; k > q; )
              --k in this ? (this[--h] = this[k]) : delete this[--h];
          return this;
        };
  },
  "es6",
  ...
  return function (n) {
    ...
    (function () {
      ...
      if (a.instantiateWasm)
        try {
          ...
          return (
            fa("Module.instantiateWasm callback failed with error: " + f), !1
          );
        }
      (function () {
        return ka ||
    ...
    var eb = (a._emscripten_bind_VoidPtr___destroy___0 = function () {
      ...
      Ja = (a._emscripten_bind_DecoderBuffer_DecoderBuffer_0 = function () {
        return (Ja = a._emscripten_bind_DecoderBuffer_DecoderBuffer_0 =
      ...
      Ma = (a._emscripten_bind_PointAttribute_PointAttribute_0 = function () {
        return (Ma = a._emscripten_bind_PointAttribute_PointAttribute_0 =
      ...
      Pa = (a._emscripten_bind_PointCloud_PointCloud_0 = function () {
        return (Pa = a._emscripten_bind_PointCloud_PointCloud_0 =
          a.asm.P).apply(null, arguments);
      }),
      ...
      Qa = (a._emscripten_bind_Mesh_Mesh_0 = function () {
        return (Qa = a._emscripten_bind_Mesh_Mesh_0 = a.asm.T).apply(
          null,
          arguments
        );
      }),
      ...
      Ra = (a._emscripten_bind_Metadata_Metadata_0 = function () {
        return (Ra = a._emscripten_bind_Metadata_Metadata_0 = a.asm.Y).apply(
          null,
          arguments
        );
      }),
      ...
      Ta = (a._emscripten_bind_DracoInt8Array_DracoInt8Array_0 = function () {
        return (Ta = a._emscripten_bind_DracoInt8Array_DracoInt8Array_0 =
      ...
      Ua = (a._emscripten_bind_DracoUInt8Array_DracoUInt8Array_0 = function () {
        return (Ua = a._emscripten_bind_DracoUInt8Array_DracoUInt8Array_0 =
      ...
      Va = (a._emscripten_bind_DracoInt16Array_DracoInt16Array_0 = function () {
        return (Va = a._emscripten_bind_DracoInt16Array_DracoInt16Array_0 =
      ...
      Wa = (a._emscripten_bind_DracoUInt16Array_DracoUInt16Array_0 =
        function () {
          return (Wa = a._emscripten_bind_DracoUInt16Array_DracoUInt16Array_0 =
      ...
      Xa = (a._emscripten_bind_DracoInt32Array_DracoInt32Array_0 = function () {
        return (Xa = a._emscripten_bind_DracoInt32Array_DracoInt32Array_0 =
      ...
      Ya = (a._emscripten_bind_DracoUInt32Array_DracoUInt32Array_0 =
        function () {
          return (Ya = a._emscripten_bind_DracoUInt32Array_DracoUInt32Array_0 =
      ...
      Za = (a._emscripten_bind_MetadataQuerier_MetadataQuerier_0 = function () {
        return (Za = a._emscripten_bind_MetadataQuerier_MetadataQuerier_0 =
          a.asm.Ea).apply(null, arguments);
      }),
      ...
      $a = (a._emscripten_bind_Decoder_Decoder_0 = function () {
        return ($a = a._emscripten_bind_Decoder_Decoder_0 = a.asm.Na).apply(
          null,
          arguments
        );
      }),
    ...
    l.__cache__ = {};
    a.Decoder = l;
    l.prototype.DecodeArrayToPointCloud = l.prototype.DecodeArrayToPointCloud =
      function (b, c, d) {
        var f = this.ptr;
        r.prepare();
        "object" == typeof b && (b = wa(b));
    ...
    l.prototype.DecodeArrayToMesh = l.prototype.DecodeArrayToMesh = function (
      b,
      c,
      d
    ) {
    ...
    l.prototype.GetAttributeByUniqueId = l.prototype.GetAttributeByUniqueId =
      function (b, c) {
        var d = this.ptr;
        b && "object" === typeof b && (b = b.ptr);
        c && "object" === typeof c && (c = c.ptr);
    ...
    l.prototype.GetTrianglesUInt16Array = l.prototype.GetTrianglesUInt16Array =
      function (b, c, d) {
        var f = this.ptr;
        b && "object" === typeof b && (b = b.ptr);
        c && "object" === typeof c && (c = c.ptr);
    ...
    l.prototype.GetAttributeFloat = l.prototype.GetAttributeFloat = function (
      b,
      c,
      d
    ) {
    ...
    l.prototype.GetAttributeDataArrayForAllPoints =
      l.prototype.GetAttributeDataArrayForAllPoints = function (b, c, d, f, t) {
        var X = this.ptr;
        b && "object" === typeof b && (b = b.ptr);
        c && "object" === typeof c && (c = c.ptr);
        d && "object" === typeof d && (d = d.ptr);
    ...
    l.prototype.SkipAttributeTransform = l.prototype.SkipAttributeTransform =
      function (b) {
        var c = this.ptr;
        b && "object" === typeof b && (b = b.ptr);
        Nc(c, b);
    ...
    l.prototype.DecodeBufferToMesh = l.prototype.DecodeBufferToMesh = function (
      b,
      c
    ) {
      var d = this.ptr;
