define([
  ...
  b.getPosition = function (t, e, o, a, r) {
    const n = e.cartesianToCartographic(t, P),
  ...
  const _ = new i.Cartesian3(),
    ...
    A = new i.Matrix4(),
    I = Math.pow(2, 12);
  function q(t, e, o, r, n, s, c, u, d, l) {
    let m,
      h,
      f = z.NONE;
  ...
  q.prototype.encode = function (t, e, o, a, s, c, u, d) {
    const l = a.x,
      m = a.y;
  ...
  const V = new i.Cartesian3(),
    G = new i.Cartesian3();
  (q.prototype.addGeodeticSurfaceNormals = function (t, e, i) {
    ...
    (q.prototype.decodePosition = function (t, e, o) {
      if (
    ...
    (q.prototype.getExaggeratedPosition = function (t, e, i) {
      ...
      if (1 !== o && this.hasGeodeticSurfaceNormals) {
        const r = this.decodeGeodeticSurfaceNormal(t, e, G),
          ...
          s = b.getHeight(n, o, a) - n;
        (i.x += r.x * s), (i.y += r.y * s), (i.z += r.z * s);
      }
      return i;
    }),
    (q.prototype.decodeTextureCoordinates = function (t, e, o) {
      return (
    ...
    (q.prototype.getOctEncodedNormal = function (t, e, o) {
      const a = t[(e = e * this.stride + this._offsetVertexNormal)] / 256,
        r = Math.floor(a),
        n = 256 * (a - r);
      return i.Cartesian2.fromElements(r, n, o);
    }),
    (q.prototype.decodeGeodeticSurfaceNormal = function (t, e, i) {
      return (
    ...
    (q.prototype._calculateStrideAndOffsets = function () {
      let t = 0;
