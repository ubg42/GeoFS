define([
  ...
  "./when-229515d6",
  "./EllipsoidTangentPlane-7d47054e",
  ...
  c.fromPoints = function (a, t) {
    ...
    let f,
      ...
      O = 0;
    for (n = 0; n < i; n++)
      (f = e.Cartesian3.subtract(a[n], s, l)),
        (p += f.x * f.x),
        (g += f.x * f.y),
        (w += f.x * f.z),
        (y += f.y * f.y),
    ...
    (P[0] = p),
      ...
      (P[7] = N),
      (P[8] = O);
    const b = e.Matrix3.computeEigenDecomposition(P, M),
      T = e.Matrix3.clone(b.unitary, t.halfAxes);
    let A = e.Matrix3.getColumn(T, 0, d),
      I = e.Matrix3.getColumn(T, 1, h),
      R = e.Matrix3.getColumn(T, 2, x),
      E = -Number.MAX_VALUE,
      S = -Number.MAX_VALUE,
      U = -Number.MAX_VALUE,
      L = Number.MAX_VALUE,
    ...
    for (n = 0; n < i; n++)
      (f = a[n]),
        ...
        (U = Math.max(e.Cartesian3.dot(R, f), U)),
        (L = Math.min(e.Cartesian3.dot(A, f), L)),
        (z = Math.min(e.Cartesian3.dot(I, f), z)),
        (B = Math.min(e.Cartesian3.dot(R, f), B));
    ...
    const V = e.Cartesian3.add(A, I, t.center);
  ...
  const f = new e.Cartesian3(),
    p = new e.Cartesian3();
  function g(a, t, n, i, s, o, C, l, u, d, h) {
    r.defined(h) || (h = new c());
    const x = h.halfAxes;
    ...
    let m = f;
    (m.x = (s + o) / 2), (m.y = (C + l) / 2), (m.z = (u + d) / 2);
    const M = p;
    (M.x = (o - s) / 2), (M.y = (l - C) / 2), (M.z = (d - u) / 2);
    const g = h.center;
    return (
  ...
  (c.fromRectangle = function (a, t, n, c, C) {
    ...
    if (
      ...
      const r = e.Rectangle.center(a, w),
        s = c.cartographicToCartesian(r, y),
        f = new i.EllipsoidTangentPlane(s, c);
      M = f.plane;
      const p = r.longitude,
        _ = a.south < 0 && a.north > 0 ? 0 : r.latitude,
        k = e.Cartographic.fromRadians(p, a.north, n, N),
        W = e.Cartographic.fromRadians(a.west, a.north, n, O),
        D = e.Cartographic.fromRadians(a.west, _, n, P),
        X = e.Cartographic.fromRadians(a.west, a.south, n, b),
        q = e.Cartographic.fromRadians(p, a.south, n, T),
      ...
      const G = c.cartographicToCartesian(q, S),
        F = f.projectPointToNearestOnPlane(j, U),
        H = f.projectPointToNearestOnPlane(Z, L),
        J = f.projectPointToNearestOnPlane(v, z),
        K = f.projectPointToNearestOnPlane(Y, B),
        Q = f.projectPointToNearestOnPlane(G, V);
      return (
        (l = Math.min(H.x, J.x, K.x)),
        (u = -l),
        (h = Math.max(H.y, F.y)),
        (d = Math.min(K.y, Q.y)),
        (W.height = X.height = t),
        ...
        (x = Math.min(
          o.Plane.getPointDistance(M, Z),
          o.Plane.getPointDistance(M, Y)
        )),
        (m = n),
        g(f.origin, f.xAxis, f.yAxis, f.zAxis, l, u, d, h, x, m, C)
      );
    }
    const f = a.south > 0,
      p = a.north < 0,
      Y = f ? a.south : p ? a.north : 0,
    ...
    M = o.Plane.fromPointNormal(F, H, v);
    ...
    (u = e.Cartesian3.dot(o.Plane.projectPointOntoPlane(M, Q, X), K)),
      (l = -u),
      (h = e.Cartesian3.fromRadians(0, a.north, p ? t : n, c, q).z),
      (d = e.Cartesian3.fromRadians(0, a.south, f ? t : n, c, j).z);
    const $ = e.Cartesian3.fromRadians(a.east, Y, n, c, Z);
    return (
      (x = o.Plane.getPointDistance(M, $)),
      (m = 0),
      g(F, K, J, H, l, u, d, h, x, m, C)
    );
  }),
    ...
    (c.intersectPlane = function (a, n) {
      const r = a.center,
        ...
        u = e.Cartesian3.dot(i, r) + n.distance;
      return u <= -l
        ? t.Intersect.OUTSIDE
        : u >= l
        ? t.Intersect.INSIDE
  ...
  c.distanceSquaredTo = function (a, t) {
    ...
    const C = e.Cartesian3.magnitude(i),
      l = e.Cartesian3.magnitude(o),
      u = e.Cartesian3.magnitude(c);
    let d = !0,
      h = !0,
      x = !0;
    C > 0 ? e.Cartesian3.divideByScalar(i, C, i) : (d = !1),
      l > 0 ? e.Cartesian3.divideByScalar(o, l, o) : (h = !1),
      u > 0 ? e.Cartesian3.divideByScalar(c, u, c) : (x = !1);
    const m = !d + !h + !x;
    let M, p, g;
    if (1 === m) {
      let a = i;
      (M = o),
        (p = c),
        h ? x || ((a = c), (p = i)) : ((a = o), (M = i)),
        (g = e.Cartesian3.cross(M, p, J)),
        a === i ? (i = g) : a === o ? (o = g) : a === c && (c = g);
    } else if (2 === m) {
      (M = i), h ? (M = o) : x && (M = c);
      let a = e.Cartesian3.UNIT_Y;
      a.equalsEpsilon(M, s.CesiumMath.EPSILON3) && (a = e.Cartesian3.UNIT_X),
        (p = e.Cartesian3.cross(M, a, H)),
        e.Cartesian3.normalize(p, p),
        (g = e.Cartesian3.cross(M, p, J)),
        e.Cartesian3.normalize(g, g),
        M === i
          ? ((o = p), (c = g))
          : M === o
          ? ((c = p), (i = g))
    ...
    const w = K;
    (w.x = e.Cartesian3.dot(n, i)),
      (w.y = e.Cartesian3.dot(n, o)),
      (w.z = e.Cartesian3.dot(n, c));
    let y,
      N = 0;
    return (
      w.x < -C
  ...
  c.computePlaneDistances = function (a, n, i, s) {
    ...
    const C = a.center,
      l = a.halfAxes,
      u = e.Matrix3.getColumn(l, 0, Y),
      d = e.Matrix3.getColumn(l, 1, G),
      h = e.Matrix3.getColumn(l, 2, F),
      x = e.Cartesian3.add(u, d, Q);
    e.Cartesian3.add(x, h, x), e.Cartesian3.add(x, C, x);
    const m = e.Cartesian3.subtract(x, n, $);
    let M = e.Cartesian3.dot(i, m);
    return (
      (o = Math.min(M, o)),
      (c = Math.max(M, c)),
      e.Cartesian3.add(C, u, x),
  ...
  const aa = new t.BoundingSphere();
  (c.isOccluded = function (a, e) {
    const n = t.BoundingSphere.fromOrientedBoundingBox(a, aa);
