define([
  ...
  (i.transform = function (n, a, t) {
    ...
    let f = e.Cartesian4.fromElements(r.x, r.y, r.z, s, l);
    f = e.Matrix4.multiplyByVector(o, f, f);
    const d = e.Cartesian3.fromCartesian4(f, C);
    return (
      (f = e.Cartesian4.divideByScalar(f, e.Cartesian3.magnitude(d), f)),
      i.fromCartesian4(f, t)
    );
  }),
