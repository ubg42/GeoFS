define([
  "./AxisAlignedBoundingBox-0eaa4f31",
  "./Matrix2-750f4cba",
  "./when-229515d6",
  "./TerrainEncoding-0e636976",
  "./IndexDatatype-0d82a76e",
  "./ComponentDatatype-1c33f2a7",
  "./RuntimeError-608565a6",
  "./Transforms-c2c34168",
  "./WebMercatorProjection-a976ce78",
  "./createTaskProcessorWorker",
  "./AttributeCompression-be355ef7",
  "./WebGLConstants-f63312fc",
  "./combine-6d9c3903",
], function (e, t, r, n, o, i, a, s, c, d, h, u, l) {
  "use strict";
  function I() {
  ...
  const g = [];
  I.getRegularGridIndices = function (e, t) {
    let n = g[e];
    r.defined(n) || (g[e] = n = []);
    let o = n[t];
    return (
  ...
  const m = [];
  I.getRegularGridIndicesAndEdgeIndices = function (e, t) {
    let n = m[e];
    r.defined(n) || (m[e] = n = []);
    let o = n[t];
    if (!r.defined(o)) {
      const r = I.getRegularGridIndices(e, t),
        i = E(e, t),
  ...
  (I.getRegularGridAndSkirtIndicesAndEdgeIndices = function (e, t) {
    let n = T[e];
    r.defined(n) || (T[e] = n = []);
    let i = n[t];
    if (!r.defined(i)) {
    ...
    (I.addSkirtIndices = function (e, t, r, n, o, i, a) {
      let s = o;
      (a = p(e, s, i, a)),
        (s += e.length),
        (a = p(t, s, i, a)),
    ...
    (I.heightmapTerrainQuality = 0.25),
    (I.getEstimatedLevelZeroGeometricErrorForAHeightmap = function (e, t, r) {
      return (
        (2 * e.maximumRadius * Math.PI * I.heightmapTerrainQuality) / (t * r)
      );
    }),
    (I.prototype.requestTileGeometry =
      a.DeveloperError.throwInstantiationError),
    (I.prototype.getLevelMaximumGeometricError =
      a.DeveloperError.throwInstantiationError),
    (I.prototype.getTileDataAvailable =
      a.DeveloperError.throwInstantiationError),
    (I.prototype.loadTileDataAvailability =
      a.DeveloperError.throwInstantiationError);
  const y = 32767,
    N = new t.Cartesian3(),
    w = new t.Cartesian3(),
  ...
  function b(e, r, n, o, a, s, c, d, h) {
    ...
    for (let a = 0; a < T; ++a) {
      const T = e[a],
        E = n[T],
        f = o[T];
      (M.longitude = i.CesiumMath.lerp(m, g, f.x)),
        (M.latitude = i.CesiumMath.lerp(I, l, f.y)),
        (M.height = E - r);
      const p = s.cartographicToCartesian(M, N);
      t.Matrix4.multiplyByPoint(c, p, p),
        t.Cartesian3.minimumByComponent(p, d, d),
        t.Cartesian3.maximumByComponent(p, h, h),
        (u = Math.min(u, M.height));
    }
    return u;
  }
  function A(e, t, n, o, a, s, d, h, u, l, I, g, m, T) {
    const E = r.defined(d),
      f = u.north,
      p = u.south;
    let y = u.east;
    const w = u.west;
    y < w && (y += i.CesiumMath.TWO_PI);
    const S = n.length;
    for (let r = 0; r < S; ++r) {
      const u = n[r],
        S = a[u],
        b = s[u];
      (M.longitude = i.CesiumMath.lerp(w, y, b.x) + m),
        (M.latitude = i.CesiumMath.lerp(p, f, b.y) + T),
        (M.height = S - l);
      const A = h.cartographicToCartesian(M, N);
      if (E) {
        const e = 2 * u;
        (x.x = d[e]), (x.y = d[e + 1]);
      }
      ...
      o.hasWebMercatorT &&
        (C =
          (c.WebMercatorProjection.geodeticLatitudeToMercatorAngle(M.latitude) -
            I) *
          g),
        o.hasGeodeticSurfaceNormals && (W = h.geodeticSurfaceNormal(A)),
        (t = o.encode(e, t, A, b, M.height, x, C, W));
    }
  }
  function C(e, t) {
    let n;
  ...
  return d(function (a, d) {
    ...
    for (let e = 0; e < u; ++e) {
      const r = B[e],
        ...
        o = r / y,
        a = n / y,
        s = i.CesiumMath.lerp(F, H, L[e] / y);
      (M.longitude = i.CesiumMath.lerp(W, P, o)),
        (M.latitude = i.CesiumMath.lerp(v, D, a)),
        (M.height = s),
        (J = Math.min(M.longitude, J)),
        ($ = Math.max(M.longitude, $)),
        (ee = Math.min(M.latitude, ee)),
        (te = Math.max(M.latitude, te));
      const d = k.cartographicToCartesian(M);
      (U[e] = new t.Cartesian2(o, a)),
        ...
        t.Matrix4.multiplyByPoint(V, d, N),
        t.Cartesian3.minimumByComponent(N, X, X),
        t.Cartesian3.maximumByComponent(N, Z, Z);
    }
    const re = C(a.westIndices, function (e, t) {
        return U[e].y - U[t].y;
      }),
      ne = C(a.eastIndices, function (e, t) {
        return U[t].y - U[e].y;
      }),
      oe = C(a.southIndices, function (e, t) {
        return U[t].x - U[e].x;
      }),
      ie = C(a.northIndices, function (e, t) {
        return U[e].x - U[t].x;
      });
    let ae;
    if (F < 0) {
    ...
    (se = Math.min(
      se,
      b(a.westIndices, a.westSkirtHeight, z, U, p, k, V, X, Z)
    )),
      (se = Math.min(
        se,
        b(a.southIndices, a.southSkirtHeight, z, U, p, k, V, X, Z)
      )),
      (se = Math.min(
        se,
        b(a.eastIndices, a.eastSkirtHeight, z, U, p, k, V, X, Z)
      )),
      (se = Math.min(
        se,
        b(a.northIndices, a.northSkirtHeight, z, U, p, k, V, X, Z)
      ));
    const ce = new e.AxisAlignedBoundingBox(X, Z, _),
      de = new n.TerrainEncoding(_, ce, se, H, G, j, m, f, T, E),
      he = de.stride,
      ue = new Float32Array(u * he + g * he);
    let le = 0;
    for (let e = 0; e < u; ++e) {
      if (j) {
        const t = 2 * e;
      ...
      le = de.encode(ue, le, q[e], U[e], z[e], x, Q[e], K[e]);
    }
    const Ie = Math.max(0, 2 * (g - 4)),
      ge = a.indices.length + 3 * Ie,
      me = o.IndexDatatype.createTypedArray(u + g, ge);
    me.set(a.indices, 0);
    const Te = 1e-4,
      Ee = ($ - J) * Te,
      fe = (te - ee) * Te,
    ...
    let Se = u * he;
    return (
      A(ue, Se, re, de, z, U, l, k, p, a.westSkirtHeight, Y, O, pe, 0),
      (Se += a.westIndices.length * he),
      A(ue, Se, oe, de, z, U, l, k, p, a.southSkirtHeight, Y, O, 0, we),
      (Se += a.southIndices.length * he),
      A(ue, Se, ne, de, z, U, l, k, p, a.eastSkirtHeight, Y, O, ye, 0),
      (Se += a.eastIndices.length * he),
      A(ue, Se, ie, de, z, U, l, k, p, a.northSkirtHeight, Y, O, 0, Ne),
      I.addSkirtIndices(re, oe, ne, ie, u, me, a.indices.length),
