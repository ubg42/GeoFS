define([
  ...
  (s.sign = r.defaultValue(Math.sign, function (t) {
    ...
    (s.toSNorm = function (t, n) {
      return (
        ...
        Math.round((0.5 * s.clamp(t, -1, 1) + 0.5) * n)
      );
    }),
    ...
    (s.zeroToTwoPi = function (t) {
      ...
      const n = s.mod(t, s.TWO_PI);
      return Math.abs(n) < s.EPSILON14 && Math.abs(t) > s.EPSILON14
        ? s.TWO_PI
        : n;
    }),
    (s.mod = function (t, n) {
      return s.sign(t) === s.sign(n) && Math.abs(t) < Math.abs(n)
        ? t
        : ((t % n) + n) % n;
    }),
  ...
  (s.setRandomNumberSeed = function (t) {
    ...
    (s.fastApproximateAtan2 = function (t, n) {
      ...
      const i = r / a;
      return (
        (e = s.fastApproximateAtan(i)),
        (e = Math.abs(n) > Math.abs(t) ? s.PI_OVER_TWO - e : e),
        (e = t < 0 ? s.PI - e : e),
        (e = n < 0 ? -e : e),
        e
      );
